...
library(rlist)
setwd("..")
list.save(text, file = "dataharvestingprediction.RData")


txt<- list.load("dataharvestingprediction.RData")
...
save(dtm, file="finaldtmprediction.Rdata")
load("finaldtmprediction.Rdata")
save(myCorp, file = "finalcorpusprediction.Rdata")
load("finalcorpusprediction.Rdata")
